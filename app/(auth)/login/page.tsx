    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg border border-surface-border bg-surface-raised hover:bg-surface-overlay transition-colors text-text-primary font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {loading ? (
        ...
        <p className="mt-8 text-xs text-text-muted text-center leading-relaxed">
          ...
          <a href="/terms" className="text-text-secondary hover:text-text-primary underline">
            Terms of Service
          </a>
          . AI responses are for educational purposes only and do not constitute professional advice.
        </p>
      </div>
    </div>
  );
